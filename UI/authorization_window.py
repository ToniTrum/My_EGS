...
"background-color: rgb(65, 65, 65);")
        ...
        self.label.setMinimumSize(QtCore.QSize(290, 30))
        font = QtGui.QFont()
...
"")
        ...
        self.lineEdit_3.setStyleSheet("background-color: rgb(248, 248, 248);\n"
"border-radius: 10%")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Зарегистрироваться"))
