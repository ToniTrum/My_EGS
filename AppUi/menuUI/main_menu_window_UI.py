# Form implementation generated from reading ui file '.\main_menu_window_UI.ui'
#
...
class Ui_main_menu_window(object):
    def setupUi(self, main_menu_window):
        ...
        main_menu_window.resize(807, 571)
        main_menu_window.setStyleSheet("background-color: rgb(35, 38, 39);")
        self.verticalLayout = QtWidgets.QVBoxLayout(main_menu_window)
        self.verticalLayout.setObjectName("verticalLayout")
        self.header = QtWidgets.QFrame(parent=main_menu_window)
...
"")
        ...
        self.frame_2 = QtWidgets.QFrame(parent=main_menu_window)
...
"")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("AppUi/menuUI/icon/setting.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 613, 448))
...
"font: 63 8pt \"Yu Gothic UI Semibold\";")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("AppUi/menuUI/icon/angle-left-b.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        font.setWeight(7)
        self.page_number_button.setFont(font)
...
"font: 63 8pt \"Yu Gothic UI Semibold\";")
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("AppUi/menuUI/icon/right-arrow.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    def retranslateUi(self, main_menu_window):
        ...
        self.libraryButton.setText(_translate("main_menu_window", "Библиотека"))
        self.desiredButton.setText(_translate("main_menu_window", "Желаемое"))
        self.walletButton.setText(_translate("main_menu_window", " Кошелёк"))
        self.settingButton.setText(_translate("main_menu_window", "Настройки "))
        self.page_number_button.setText(_translate("main_menu_window", "1"))
